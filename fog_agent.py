...
#
# DEPRECATED: This monolithic agent has been superseded by the multi-agent
# FogPipeline (pipeline.py) which uses specialized agents from the agents/
# package.  This file is retained for reference only.
...
warnings.warn(
    "fog_agent.FogAgent is deprecated. Use pipeline.FogPipeline instead.",
    DeprecationWarning,
    stacklevel=2,
)
...
"""
        ...
        return safe_parse_json_response(response.content, fallback)
